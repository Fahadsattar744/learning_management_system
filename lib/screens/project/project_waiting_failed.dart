...
import 'package:tecbeck_projects/screens/user_page/my_page_screen.dart';
...
class ProjectWaitingOrFailed extends StatefulWidget {
  const ProjectWaitingOrFailed({Key? key}) : super(key: key);

  @override
  State<ProjectWaitingOrFailed> createState() => _ProjectWaitingOrFailedState();
}

class _ProjectWaitingOrFailedState extends State<ProjectWaitingOrFailed> {
