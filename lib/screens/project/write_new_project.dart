...
class WriteNewProject extends StatefulWidget {
  const WriteNewProject({Key? key}) : super(key: key);

  @override
  State<WriteNewProject> createState() => _WriteNewProjectState();
}

class _WriteNewProjectState extends State<WriteNewProject> {
  @override
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          style: ElevatedButton.styleFrom(
                              fixedSize: Size(35.w, 2.h), primary: Colors.grey),
                          onPressed: () async {},
                          child: Center(
                            child: Text(
                              'Cancel',
